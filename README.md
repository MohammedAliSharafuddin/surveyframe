...
2026-08-20. Small-sample and MCDM were once planned as two releases, v0.4
and v0.5, and text analysis had at one stage its own working label before
it, too, was folded into 0.4.0. There is no 0.3.5 and no 0.5.x.
...
Qualtrics, REDCap, or the R package
[surveydown](https://surveydown.io/) is usually a better starting point.
surveyframe reads exported CSV data from any of them (see "Already have
data?" above) if the analysis plan is added afterward.
