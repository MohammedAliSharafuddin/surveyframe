...
`surveyframe` generates model specifications and syntax for downstream
statistical packages. It does not fit `lavaan` or `seminr` models in v0.3. The
generated syntax should be reviewed, copied into the modelling package, and
fitted with modelling choices appropriate to the study.
...
Model specifications can be stored in `.sframe` files and exported as JSON.
