...
```{r wordcloud, fig.alt = "A word cloud of the most frequent terms, sized by frequency.", eval = has_ggplot}
...
`term_freq`'s word cloud uses), negative-sentiment words above the centre
line and positive-sentiment words below it, each sized by how often it
occurred.

```{r sentiment-cloud, fig.alt = "Comparison word cloud: negative-sentiment terms above the centre line in red, positive-sentiment terms below it in teal, each sized by frequency.", eval = has_tidytext && has_ggplot}
instr_cloud <- instr
