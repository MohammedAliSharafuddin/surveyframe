...
#> Static survey written to '/tmp/RtmpLawRSJ/tourism_services_survey.html' (85.2
#> KB).
...
#> Apps Script written to: /tmp/RtmpLawRSJ/surveyframe_collector.gs
...
#> Results report written: /tmp/RtmpLawRSJ/tourism_results.html
