...
#> Static survey written to '/tmp/RtmpQ3a7PG/tourism_services_survey.html' (85.2
#> KB).
...
#> Apps Script written to: /tmp/RtmpQ3a7PG/surveyframe_collector.gs
...
#> Results report written: /tmp/RtmpQ3a7PG/tourism_results.html
