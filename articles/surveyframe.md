...
#> Static survey written to '/tmp/RtmpsRdTIY/tourism_services_survey.html' (85.2
#> KB).
...
#> Apps Script written to: /tmp/RtmpsRdTIY/surveyframe_collector.gs
...
#> Results report written: /tmp/RtmpsRdTIY/tourism_results.html
