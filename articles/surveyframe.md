...
#> 1 2026-09-03T12:15:27Z instrument_revision
...
#>                                                      previous_hash
#> 1 b38ec48af871b291219237f299031a6c396b842c9aeecd9274400ff7aa280562
#>                                                           new_hash
#> 1 675dc2216ef5f001c46ddf20982680905fd251a470c860b4b291b65e723af1bb
#>   changed_fields
#> 1          items
```
...
#> Static survey written to '/tmp/Rtmpkwi52O/tourism_services_survey.html' (85.5
#> KB).
...
#> Apps Script written to: /tmp/Rtmpkwi52O/surveyframe_collector.gs
...
#> Results report written: /tmp/Rtmpkwi52O/tourism_results.html
...
#> Report rendered with the Quarto engine: /tmp/Rtmpkwi52O/tourism_report.html
```
