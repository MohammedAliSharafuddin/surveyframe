...
A branch shows or hides an item based on an earlier answer. Branch a
dedicated follow-up, not an item from a shared scale, or groups may
receive different versions of the scale being compared.
