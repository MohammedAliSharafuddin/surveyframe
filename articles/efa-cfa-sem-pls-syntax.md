...
#> <sframe validation>
#>   Model:       tourism_structural (cb_sem)
#>   Status:      valid
...
`single_item`. lavaan syntax generation is intended for reflective
measurement models, which is why the CFA and CB-SEM models use the
default reflective mode. PLS-SEM syntax uses composite constructs, as
above.
