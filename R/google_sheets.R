...
export_google_sheet <- function(instrument, sheet_url, output_dir = ".") {
  ...
  # Build the Apps Script that accepts POST and appends to sheet
  col_headers <- c("respondent_id", "started_at", "submitted_at", item_ids)
  headers_js <- paste0('"', col_headers, '"', collapse = ", ")
...
',
    instrument$meta$title,
    instrument$meta$version,
    sheet_url,
    headers_js
  )
