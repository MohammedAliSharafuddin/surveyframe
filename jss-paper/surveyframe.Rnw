...
%% -- Author information (anonymised for blind review) --------------------

\author{Anonymous}
\Plainauthor{Anonymous}
...
\Address{Withheld for blind peer review}
...
options(prompt = "R> ", continue = "+  ", width = 65,
...
<<session, echo=TRUE, results='asis'>>=
toLatex(sessionInfo())
@
