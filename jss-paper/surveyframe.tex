...
\begin{alltt}
\hlkwd{library}\hlstd{(}\hlstr{"surveyframe"}\hlstd{)}

\hlcom{## Define a shared 5-point agreement response scale}
\hlstd{agree5} \hlkwb{<-} \hlkwd{sf_choices}\hlstd{(}
  \hlkwc{id}     \hlstd{=} \hlstr{"agree5"}\hlstd{,}
  \hlkwc{values} \hlstd{=} \hlnum{1}\hlopt{:}\hlnum{5}\hlstd{,}
  \hlkwc{labels} \hlstd{=} \hlkwd{c}\hlstd{(}\hlstr{"Strongly disagree"}\hlstd{,} \hlstr{"Disagree"}\hlstd{,} \hlstr{"Neutral"}\hlstd{,}
             \hlstr{"Agree"}\hlstd{,} \hlstr{"Strongly agree"}\hlstd{)}
\hlstd{)}

\hlcom{## Define items: declare scale membership before any data exist}
\hlstd{dm_1} \hlkwb{<-} \hlkwd{sf_item}\hlstd{(}\hlstr{"dm_1"}\hlstd{,}
  \hlstr{"Social media content influences my travel decisions."}\hlstd{,}
  \hlkwc{type} \hlstd{=} \hlstr{"likert"}\hlstd{,} \hlkwc{choice_set} \hlstd{=} \hlstr{"agree5"}\hlstd{,}
  \hlkwc{scale_id} \hlstd{=} \hlstr{"digital_marketing"}\hlstd{,} \hlkwc{required} \hlstd{=} \hlnum{TRUE}\hlstd{)}

\hlstd{dm_2} \hlkwb{<-} \hlkwd{sf_item}\hlstd{(}\hlstr{"dm_2"}\hlstd{,}
  \hlstr{"Online reviews shape my destination choices."}\hlstd{,}
  \hlkwc{type} \hlstd{=} \hlstr{"likert"}\hlstd{,} \hlkwc{choice_set} \hlstd{=} \hlstr{"agree5"}\hlstd{,}
  \hlkwc{scale_id} \hlstd{=} \hlstr{"digital_marketing"}\hlstd{,} \hlkwc{required} \hlstd{=} \hlnum{TRUE}\hlstd{)}

\hlstd{dm_3} \hlkwb{<-} \hlkwd{sf_item}\hlstd{(}\hlstr{"dm_3"}\hlstd{,}
  \hlstr{"Digital promotions encourage me to visit new places."}\hlstd{,}
  \hlkwc{type} \hlstd{=} \hlstr{"likert"}\hlstd{,} \hlkwc{choice_set} \hlstd{=} \hlstr{"agree5"}\hlstd{,}
  \hlkwc{scale_id} \hlstd{=} \hlstr{"digital_marketing"}\hlstd{,} \hlkwc{required} \hlstd{=} \hlnum{TRUE}\hlstd{)}

\hlstd{sq_1} \hlkwb{<-} \hlkwd{sf_item}\hlstd{(}\hlstr{"sq_1"}\hlstd{,}
  \hlstr{"The hospitality staff were attentive and helpful."}\hlstd{,}
  \hlkwc{type} \hlstd{=} \hlstr{"likert"}\hlstd{,} \hlkwc{choice_set} \hlstd{=} \hlstr{"agree5"}\hlstd{,}
  \hlkwc{scale_id} \hlstd{=} \hlstr{"service_quality"}\hlstd{,} \hlkwc{required} \hlstd{=} \hlnum{TRUE}\hlstd{)}

\hlstd{sq_2} \hlkwb{<-} \hlkwd{sf_item}\hlstd{(}\hlstr{"sq_2"}\hlstd{,}
  \hlstr{"Facilities were clean and well maintained."}\hlstd{,}
  \hlkwc{type} \hlstd{=} \hlstr{"likert"}\hlstd{,} \hlkwc{choice_set} \hlstd{=} \hlstr{"agree5"}\hlstd{,}
  \hlkwc{scale_id} \hlstd{=} \hlstr{"service_quality"}\hlstd{,} \hlkwc{required} \hlstd{=} \hlnum{TRUE}\hlstd{)}

\hlcom{## Define scales <U+2014> scoring rule committed before data collection}
\hlstd{dm_scale} \hlkwb{<-} \hlkwd{sf_scale}\hlstd{(}
  \hlkwc{id}     \hlstd{=} \hlstr{"digital_marketing"}\hlstd{,}
  \hlkwc{label}  \hlstd{=} \hlstr{"Digital marketing effectiveness"}\hlstd{,}
  \hlkwc{items}  \hlstd{=} \hlkwd{c}\hlstd{(}\hlstr{"dm_1"}\hlstd{,} \hlstr{"dm_2"}\hlstd{,} \hlstr{"dm_3"}\hlstd{),}
  \hlkwc{method} \hlstd{=} \hlstr{"mean"}
\hlstd{)}

\hlstd{sq_scale} \hlkwb{<-} \hlkwd{sf_scale}\hlstd{(}
  \hlkwc{id}     \hlstd{=} \hlstr{"service_quality"}\hlstd{,}
  \hlkwc{label}  \hlstd{=} \hlstr{"Service quality"}\hlstd{,}
  \hlkwc{items}  \hlstd{=} \hlkwd{c}\hlstd{(}\hlstr{"sq_1"}\hlstd{,} \hlstr{"sq_2"}\hlstd{),}
  \hlkwc{method} \hlstd{=} \hlstr{"mean"}
\hlstd{)}

\hlcom{## Assemble the instrument}
\hlstd{instr} \hlkwb{<-} \hlkwd{sf_instrument}\hlstd{(}
  \hlkwc{title}       \hlstd{=} \hlstr{"Tourism Experience Survey"}\hlstd{,}
  \hlkwc{version}     \hlstd{=} \hlstr{"1.0.0"}\hlstd{,}
  \hlkwc{description} \hlstd{=} \hlstr{"Digital marketing and service quality perceptions."}\hlstd{,}
  \hlkwc{authors}     \hlstd{=} \hlstr{"J. Researcher"}\hlstd{,}
  \hlkwc{components}  \hlstd{=} \hlkwd{list}\hlstd{(agree5, dm_1, dm_2, dm_3, sq_1, sq_2,}
                     \hlstd{dm_scale, sq_scale)}
\hlstd{)}
\hlkwd{print}\hlstd{(instr)}
\end{alltt}
\begin{verbatim}
## <sframe>
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{result} \hlkwb{<-} \hlkwd{validate_sframe}\hlstd{(instr,} \hlkwc{strict} \hlstd{=} \hlnum{FALSE}\hlstd{)}
\hlstd{result}\hlopt{$}\hlstd{valid}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
\begin{alltt}
\hlstd{result}\hlopt{$}\hlstd{problems}
\end{alltt}
\begin{verbatim}
## character(0)
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{responses} \hlkwb{<-} \hlkwd{read_responses}\hlstd{(}
  \hlkwc{x}             \hlstd{=} \hlstr{"responses.csv"}\hlstd{,}
  \hlkwc{instrument}    \hlstd{= instr,}
  \hlkwc{respondent_id} \hlstd{=} \hlstr{"respondent_id"}\hlstd{,}
  \hlkwc{submitted_at}  \hlstd{=} \hlstr{"submitted_at"}
\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{demo}  \hlkwb{<-} \hlkwd{sframe_demo_data}\hlstd{()}
\hlstd{instr} \hlkwb{<-} \hlstd{demo}\hlopt{$}\hlstd{instrument}
\hlstd{resp}  \hlkwb{<-} \hlstd{demo}\hlopt{$}\hlstd{responses}

\hlcom{## Five scales, 15 items, 120 respondents}
\hlkwd{cat}\hlstd{(}\hlstr{"Scales:"}\hlstd{,} \hlkwd{length}\hlstd{(instr}\hlopt{$}\hlstd{scales),} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Scales: 5
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Items:"}\hlstd{,} \hlkwd{length}\hlstd{(instr}\hlopt{$}\hlstd{items),} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Items: 15
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Responses:"}\hlstd{,} \hlkwd{nrow}\hlstd{(resp),} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Responses: 120
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{qr} \hlkwb{<-} \hlkwd{quality_report}\hlstd{(resp, instr)}
\hlkwd{cat}\hlstd{(}\hlstr{"Respondents:"}\hlstd{, qr}\hlopt{$}\hlstd{summary}\hlopt{$}\hlstd{n_respondents,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Respondents: 120
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Items:      "}\hlstd{, qr}\hlopt{$}\hlstd{summary}\hlopt{$}\hlstd{n_items,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Items:       15
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Flagged:    "}\hlstd{, qr}\hlopt{$}\hlstd{summary}\hlopt{$}\hlstd{n_flagged,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Flagged:     109
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{scored} \hlkwb{<-} \hlkwd{score_scales}\hlstd{(resp, instr)}
\hlcom{## Scale score columns appended to the response data frame}
\hlstd{scale_cols} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{"digital_marketing"}\hlstd{,} \hlstr{"service_quality"}\hlstd{,}
                \hlstr{"sustainability"}\hlstd{,} \hlstr{"satisfaction"}\hlstd{,}
                \hlstr{"behavioural_intention"}\hlstd{)}
\hlkwd{summary}\hlstd{(scored[, scale_cols])}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwa{if} \hlstd{(}\hlkwd{requireNamespace}\hlstd{(}\hlstr{"psych"}\hlstd{,} \hlkwc{quietly} \hlstd{=} \hlnum{TRUE}\hlstd{)) \{}
  \hlstd{rr} \hlkwb{<-} \hlkwd{reliability_report}\hlstd{(resp, instr,} \hlkwc{omega} \hlstd{=} \hlnum{FALSE}\hlstd{)}
  \hlkwd{print}\hlstd{(rr)}
\hlstd{\}}
\end{alltt}
\begin{verbatim}
## Reliability Report
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{syn} \hlkwb{<-} \hlkwd{cfa_syntax}\hlstd{(instr)}
\hlkwd{cat}\hlstd{(syn)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{results} \hlkwb{<-} \hlkwd{run_analysis_plan}\hlstd{(resp, instr,} \hlkwc{scored} \hlstd{=} \hlnum{TRUE}\hlstd{)}

\hlcom{## Correlation: digital marketing and satisfaction}
\hlstd{r1} \hlkwb{<-} \hlstd{results[[}\hlnum{1}\hlstd{]]}
\hlkwd{cat}\hlstd{(}\hlstr{"Test:  "}\hlstd{, r1}\hlopt{$}\hlstd{test,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Test:   correlation_pearson
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"APA:   "}\hlstd{, r1}\hlopt{$}\hlstd{apa,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## APA:    r(118) = 0.54, p < .001
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Effect:"}\hlstd{, r1}\hlopt{$}\hlstd{effect_label,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Effect: large
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Q:"}\hlstd{,} \hlkwd{strwrap}\hlstd{(r1}\hlopt{$}\hlstd{research_question,} \hlkwc{width} \hlstd{=} \hlnum{58}\hlstd{,}
                  \hlkwc{exdent} \hlstd{=} \hlnum{3}\hlstd{),} \hlkwc{sep} \hlstd{=} \hlstr{"\textbackslash{}n    "}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Q:
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{r2} \hlkwb{<-} \hlstd{results[[}\hlnum{2}\hlstd{]]}
\hlkwd{cat}\hlstd{(}\hlstr{"Test:"}\hlstd{, r2}\hlopt{$}\hlstd{test,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Test: regression_linear
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"APA: "}\hlstd{, r2}\hlopt{$}\hlstd{apa,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## APA:  R<U+00B2> = 0.383, F(3, 116) = 23.95, p < .001
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{r3} \hlkwb{<-} \hlstd{results[[}\hlnum{3}\hlstd{]]}
\hlkwd{cat}\hlstd{(}\hlstr{"Test:"}\hlstd{, r3}\hlopt{$}\hlstd{test,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Test: mann_whitney
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"APA: "}\hlstd{, r3}\hlopt{$}\hlstd{apa,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## APA:  U = 1576, z = -0.98, p = 0.327, r = 0.09
\end{verbatim}
\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"Effect:"}\hlstd{, r3}\hlopt{$}\hlstd{effect_label,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## Effect: negligible
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{cb} \hlkwb{<-} \hlkwd{codebook_report}\hlstd{(instr)}
\hlkwd{nrow}\hlstd{(cb}\hlopt{$}\hlstd{items_table)}
\end{alltt}
\begin{verbatim}
## [1] 15
\end{verbatim}
\begin{alltt}
\hlkwd{head}\hlstd{(cb}\hlopt{$}\hlstd{items_table[,} \hlkwd{c}\hlstd{(}\hlstr{"id"}\hlstd{,} \hlstr{"type"}\hlstd{,} \hlstr{"scale_id"}\hlstd{,} \hlstr{"reverse"}\hlstd{)],} \hlnum{6}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\end{kframe}\begin{itemize}\raggedright
  ...
  \item Other packages: knitr~1.45, surveyframe~0.3.1
  \item Loaded via a namespace (and not attached):
    askpass~1.2.0, cli~3.6.2, compiler~4.3.3,
    evaluate~0.23, grid~4.3.3, highr~0.10,
    jsonlite~1.8.8, lattice~0.22-5, mnormt~2.1.1,
    nlme~3.1-164, openssl~2.1.1, parallel~4.3.3,
    psych~2.4.1, rlang~1.1.3, tools~4.3.3, xfun~0.41
\end{itemize}
