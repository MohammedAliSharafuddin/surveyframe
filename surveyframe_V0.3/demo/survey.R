...
cat("4. Confirm that the bundled demo questions are already visible in the item list.\n")
cat("5. Click any item and review its settings in the inspector panel.\n")
cat("6. Switch to Preview, then use Welcome, Survey, and Thank You tabs.\n")
cat("7. Switch to Analyse and review the preloaded variables, scales, and analysis plans.\n")
cat("8. Click Save .sframe when you want to keep the instrument.\n\n")
