...
out <- export_static_survey(instr,
                             ...
                             open = FALSE)
#> Static survey written to '/tmp/RtmpRQP4vD/sat.html' (44.8 KB).
file.exists(out)
#> [1] TRUE
...
export_static_survey(instr,
                     ...
                     overwrite = TRUE)
#> Static survey written to '/tmp/RtmpRQP4vD/sat_browser.html' (44.8 KB).
...
#> Static survey written to '/tmp/RtmpRQP4vD/sat_endpoint.html' (44.9 KB).
# }
```
