...
out <- export_static_survey(instr,
                             ...
                             open = FALSE)
#> Static survey written to '/tmp/RtmpOL1cPX/sat.html' (58.3 KB).
file.exists(out)
#> [1] TRUE
...
export_static_survey(instr,
                     ...
                     overwrite = TRUE)
#> Static survey written to '/tmp/RtmpOL1cPX/sat_browser.html' (58.3 KB).
...
#> Static survey written to '/tmp/RtmpOL1cPX/sat_endpoint.html' (58.3 KB).
# }
```
