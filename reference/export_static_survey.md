...
out <- export_static_survey(instr,
                             ...
                             open = FALSE)
#> Static survey written to '/tmp/Rtmp44tQ8U/sat.html' (68.6 KB).
file.exists(out)
#> [1] TRUE
...
export_static_survey(instr,
                     ...
                     overwrite = TRUE)
#> Static survey written to '/tmp/Rtmp44tQ8U/sat_browser.html' (68.6 KB).
...
#> Static survey written to '/tmp/Rtmp44tQ8U/sat_endpoint.html' (68.6 KB).
# }
```
