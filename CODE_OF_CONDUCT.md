...
Like the technical community as a whole, the Surveyframe team and
...
This code of conduct applies to all spaces managed by the Surveyframe
project or . This includes IRC, the mailing lists, the issue tracker,
DSF events, and any other forums created by the project team which the
...
report it by emailing [](mailto:). For more details please see our
...
- **Be respectful.** Not all of us will agree all the time, but
  ...
  a productive one. Members of the Surveyframe community should be
  respectful when dealing with other members as well as with people
  outside the Surveyframe community.
...
- **When we disagree, try to understand why.** Disagreements, both
  social and technical, happen all the time and Surveyframe is no
  ...
  Surveyframe comes from its varied community, people from a wide range
...
project](http://web.archive.org/web/20141109123859/http://speakup.io/coc.md).

## Questions?

If you have questions, please see . If that doesn’t answer your
questions, feel free to [contact us](mailto:).
