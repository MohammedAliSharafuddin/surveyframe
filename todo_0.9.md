# todo_0.9.md — surveyframe v0.9: Provenance part two (SHA Layers 4-5)

Dev-only planning file, tracked on `dev` only. Its name is in `.gitignore`
and `.Rbuildignore`. Companion to `CLAUDE.md`, `todo_0.8.md` (must be
shipped first — the chain is contiguous), and
`../portfolio-planner/development_instructions/07_v08_v09_implementation.md`
(v0.9 section, including the 2026-07-14 Layer 5 chaining revision).
